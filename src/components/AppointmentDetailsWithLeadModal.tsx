  ...
  return (
    <>
      ...
      <div className="fixed inset-0 flex items-center justify-center z-[110] p-4 overflow-y-auto pointer-events-none">
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl w-full max-w-4xl max-h-[85vh] overflow-y-auto my-4 pointer-events-auto" onClick={(e) => e.stopPropagation()}>
          <div className="sticky top-0 bg-white rounded-t-3xl p-6 border-b border-gray-200/30 flex items-center justify-between z-10">
            <h2 id="modalTitle" className="text-xl font-light text-gray-900">Détails du rendez-vous</h2>
            <button
              onClick={onClose}
          ...
          <div className="p-6 space-y-6">
            <div className="bg-gradient-to-r from-blue-50 to-blue-100/50 rounded-2xl p-5">
              ...
              <p className="text-sm text-gray-600 font-light">{fullName}</p>
            </div>

            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              <div className="space-y-4">
                <h4 className="text-sm font-medium text-gray-700 mb-3">Informations du rendez-vous</h4>

                <div className="grid grid-cols-2 gap-3">
                  <div className="flex items-start gap-3 p-4 bg-white/80 rounded-2xl border border-gray-200/50">
                    <Calendar className="w-5 h-5 text-blue-500 mt-0.5 flex-shrink-0" />
                    <div>
                      <p className="text-xs text-gray-500 font-light mb-1">Date</p>
                  ...
                  <div className="flex items-start gap-3 p-4 bg-white/80 rounded-2xl border border-gray-200/50">
                    ...
                    <div>
                      <p className="text-xs text-gray-500 font-light mb-1">Heure</p>
                  ...
                  <div className="flex items-start gap-3 p-4 bg-white/80 rounded-2xl border border-gray-200/50">
                    ...
                    <div>
                      <p className="text-xs text-gray-500 font-light mb-1">Durée</p>
                  ...
                  <div className="flex items-start gap-3 p-4 bg-white/80 rounded-2xl border border-gray-200/50">
                    ...
                    <div>
                      <p className="text-xs text-gray-500 font-light mb-1">Rappel</p>
                ...
                {appointment.location && (
                  <div className="flex items-start gap-3 p-4 bg-white/80 rounded-2xl border border-gray-200/50">
                    ...
                    <div className="flex-1">
                      <p className="text-xs text-gray-500 font-light mb-1">Lieu</p>
                ...
                {appointment.calendarName && (
                  <div className="flex items-start gap-3 p-4 bg-white/80 rounded-2xl border border-gray-200/50">
                    ...
                    <div className="flex-1">
                      <p className="text-xs text-gray-500 font-light mb-1">Calendrier</p>
                ...
                {appointment.google_calendar_link && (
                  <div className="flex items-start gap-3 p-4 bg-white/80 rounded-2xl border border-gray-200/50">
                    ...
                    <div className="flex-1">
                      <p className="text-xs text-gray-500 font-light mb-1">Google Agenda</p>
                      <a
              ...
              <div className="space-y-4">
                <h4 className="text-sm font-medium text-gray-700 mb-3">Informations du lead</h4>

                <div className="bg-gradient-to-br from-blue-50 to-violet-50 rounded-2xl p-5 border border-blue-200/30">
                  <div className="flex items-center gap-3 mb-4">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-600 font-light">Lead</p>
                    </div>
                  </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <a href={`tel:${lead.phone}`} className="text-sm text-gray-700 hover:text-green-600 transition-colors">
                        {lead.phone}
                      </a>
                    </div>
                    ...
                    {lead.residence_status && (
                      <div className="pt-2 border-t border-blue-200/30">
                        <p className="text-xs text-gray-600 font-light mb-1">Statut de résidence</p>
                    ...
                    {lead.profession && (
                      <div className="pt-2 border-t border-blue-200/30">
                        <p className="text-xs text-gray-600 font-light mb-1">Profession</p>
              ...
              <div className="space-y-3">
                {appointment.notes && (
                  <div className="p-4 bg-amber-50/50 rounded-2xl border border-amber-200/50">
                    <p className="text-xs text-gray-600 font-medium mb-2">Notes du rendez-vous</p>
                    <p className="text-sm text-gray-700 whitespace-pre-wrap">{appointment.notes}</p>
                  </div>
                )}

                {lead.notes && (
                  <div className="p-4 bg-blue-50/50 rounded-2xl border border-blue-200/50">
                    <p className="text-xs text-gray-600 font-medium mb-2">Notes complémentaires du lead</p>
          ...
          <div className="sticky bottom-0 bg-white/95 backdrop-blur-xl p-6 border-t border-gray-200/30">
            <div className="flex gap-3">
              <button
                onClick={() => onEdit(appointment)}
                className="flex-1 px-6 py-2.5 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-full text-sm font-light hover:from-blue-600 hover:to-blue-700 shadow-md transition-all flex items-center justify-center gap-2"
              >
              ...
              <button
                ...
                className="flex-1 px-6 py-2.5 bg-white/80 border border-red-200/50 text-red-600 rounded-full text-sm font-light hover:bg-red-50 transition-all flex items-center justify-center gap-2"
              >
      ...
      {showDeleteConfirm && (
        <div className="fixed inset-0 z-[10000] flex items-center justify-center p-4 animate-fadeIn bg-black/30 backdrop-blur-sm">
          <div className="bg-white rounded-3xl shadow-2xl w-full max-w-md p-6 border border-red-200/50">
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 font-light">Cette action est irréversible</p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 px-6 py-2.5 bg-white/80 border border-gray-200/50 text-gray-700 rounded-full text-sm font-light hover:bg-gray-50 transition-all"
              >
                Annuler
              </button>
              <button
                onClick={handleDelete}
                className="flex-1 px-6 py-2.5 bg-gradient-to-r from-red-500 to-red-600 text-white rounded-full text-sm font-light hover:from-red-600 hover:to-red-700 shadow-md transition-all"
              >
                Supprimer
              </button>
            </div>
