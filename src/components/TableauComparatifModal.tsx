  ...
  return createPortal(
    <>
      ...
      <div className="fixed inset-0 flex items-center justify-center z-[9999] p-4 overflow-y-auto pointer-events-none">
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl w-full max-w-4xl my-4 pointer-events-auto" onClick={(e) => e.stopPropagation()}>
          {/* Header */}
          <div className="p-6 border-b border-gray-200/30 flex items-center justify-between sticky top-0 bg-white rounded-t-3xl z-10">
            <h2 className="text-xl font-light text-gray-900">Tableau comparatif</h2>
            <button
              onClick={onClose}
          ...
          <div className="flex items-center justify-between mb-4">
              ...
              {showColumnInput ? (
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="px-3 py-1.5 border border-gray-200/50 rounded-2xl text-xs font-light focus:outline-none focus:ring-2 focus:ring-blue-500/50 bg-white/80"
                  />
                  <button
                    onClick={() => {
                      if (columnName.trim()) {
                    ...
                    className="px-3 py-1.5 bg-white border border-blue-500 text-blue-600 rounded-full text-xs font-light hover:bg-blue-50 transition-all whitespace-nowrap"
                  >
                    Ajouter
                  </button>
                </div>
            ...
            <div className="flex items-center gap-2">
              <button className="px-3 py-1.5 bg-white border border-blue-500 text-blue-600 rounded-full text-xs font-light hover:bg-blue-50 transition-all flex items-center gap-1.5 whitespace-nowrap">
              ...
              <button className="px-3 py-1.5 bg-white border border-blue-500 text-blue-600 rounded-full text-xs font-light hover:bg-blue-50 transition-all whitespace-nowrap">
                Proposition
              </button>
          ...
          {/* Table */}
          <div className="border border-gray-200/50 rounded-2xl overflow-hidden max-h-[400px] overflow-y-auto">
            <table className="w-full">
              <thead>
                <tr className="bg-blue-50 border-b border-gray-200">
                  <th className="px-3 py-2 text-left text-xs font-normal text-gray-700"></th>
                  <th className="px-3 py-2 text-right">
                    <span className="text-xs font-light text-gray-600">ACTIONS</span>
                  </th>
                </tr>
              </thead>
              <tbody>
          ...
          <div className="mt-4 p-3 bg-gray-50/80 rounded-2xl">
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-xs font-light text-gray-700">Personnalisé</span>
            </div>

            <div className="flex items-center gap-2">
              <select className="flex-1 px-3 py-1.5 border border-gray-200/50 rounded-2xl text-xs font-light focus:outline-none focus:ring-2 focus:ring-blue-500/50 bg-white/80">
