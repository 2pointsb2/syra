  ...
  return createPortal(
    <>
      ...
      <div className="fixed inset-0 flex items-center justify-center z-[110] p-4 overflow-y-auto pointer-events-none">
        <div className="bg-white rounded-3xl shadow-2xl w-full max-w-6xl my-4 overflow-hidden flex flex-col pointer-events-auto" onClick={(e) => e.stopPropagation()}>
          {/* Header */}
            ...
            <div className="flex-1 flex flex-col p-8 space-y-6">
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-4 py-4 bg-gray-50 border border-gray-200 rounded-2xl text-base focus:outline-none focus:ring-2 focus:ring-teal-500/20 focus:border-teal-400 font-light"
                  autoFocus
                />
              </div>
                ...
                <div className="space-y-2 max-h-96 overflow-y-auto">
                  {searchResults.map((lead) => (
                    <button
                      ...
                      className="w-full p-4 bg-white hover:bg-gray-50 border border-gray-200 rounded-2xl flex items-center gap-4 transition-all text-left"
                    >
                      ...
                      <div className="flex-1">
                        <p className="text-base font-light text-gray-900">{lead.first_name} {lead.last_name}</p>
                        <p className="text-sm text-gray-600 font-light">{lead.email} • {lead.phone}</p>
                      </div>
                    </button>
                  ))}
                </div>
          ...
          {currentStep === 'form' && (
            <>
              ...
              <div className="flex-1 overflow-y-auto p-8">
                {activeTab === 'GENERAL' && (
                  <div className="space-y-6">
                    <div className="flex items-center gap-4">
                      <span className="text-sm font-light text-gray-700">TNS</span>
                    ...
                    <div className="grid grid-cols-4 gap-4">
                      <div>
                        ...
                        <select
                          ...
                          className="w-full px-4 py-2 border border-gray-200 rounded-xl text-sm font-light focus:outline-none focus:ring-2 focus:ring-teal-500/20 focus:border-teal-400"
                        >
                          <option>M.</option>
                          <option>Mme.</option>
                        </select>
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        <label className="block text-sm font-light text-gray-700 mb-2">Site internet</label>
                        <input
                          type="url"
                    ...
                    <div className="grid grid-cols-4 gap-4">
                      <div className="col-span-2">
                        <label className="block text-sm font-light text-gray-700 mb-2">Adresse</label>
                        <input
                          type="text"
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <div>
                        <label className="block text-sm font-light text-gray-700 mb-2">Date de Naissance</label>
                        <input
                          type="date"
                      ...
                      <div>
                        <label className="block text-sm font-light text-gray-700 mb-2">Statut Professionnel</label>
                        <select
                      ...
                      <div>
                        <label className="block text-sm font-light text-gray-700 mb-2">Profession</label>
                        <input
                          type="text"
                    ...
                    <div className="grid grid-cols-3 gap-4">
                      <div>
                        <label className="block text-sm font-light text-gray-700 mb-2">Caisse professionnelle</label>
                        <select
                    ...
                    <div className="grid grid-cols-4 gap-4">
                      <div>
                        <label className="block text-sm font-light text-gray-700 mb-2">Rémuneration</label>
                        <input
                          type="text"
                      ...
                      <div>
                        <label className="block text-sm font-light text-gray-700 mb-2">Dividende</label>
                        <input
                          type="text"
                      ...
                      <div>
                        <label className="block text-sm font-light text-gray-700 mb-2">Crédit en cours</label>
                        <input
                          type="text"
                      ...
                      <div>
                        <label className="block text-sm font-light text-gray-700 mb-2">Autres revenus</label>
                        <input
                          type="text"
                    ...
                    <div>
                      <label className="block text-sm font-light text-gray-700 mb-2">Commentaire</label>
                      <textarea
                        value={formData.commentaire}
                        onChange={(e) => updateFormField('commentaire', e.target.value)}
                        rows={4}
                        className="w-full px-4 py-3 border border-gray-200 rounded-xl text-sm font-light focus:outline-none focus:ring-2 focus:ring-teal-500/20 focus:border-teal-400 resize-none"
                      />
                    </div>
                ...
                {activeTab === 'AUTRES' && (
                  <div className="flex items-center justify-center h-64">
                    <p className="text-gray-500 font-light">Section Autres - À venir</p>
                  </div>
                )}
              </div>
              ...
              <div className="bg-gray-50 px-8 py-4 border-t border-gray-200 flex justify-between">
                <button
                  onClick={onClose}
                  className="px-8 py-3 text-gray-600 hover:text-gray-900 font-light transition-colors"
                >
                  Annuler
                </button>
                <button
