  ...
  return (
    <>
      ...
      <div className="fixed inset-0 flex items-center justify-center z-[110] p-4 overflow-y-auto pointer-events-none">
        <div className="bg-white/95 backdrop-blur-xl rounded-3xl shadow-2xl w-full max-w-lg my-4 p-8 text-center pointer-events-auto" onClick={(e) => e.stopPropagation()}>
          <button
            onClick={onClose}
          ...
          <div className="w-24 h-24 mx-auto mb-6 rounded-full bg-gradient-to-br from-blue-100 to-blue-50 flex items-center justify-center">
            <CalendarPlus className="w-12 h-12 text-blue-600" />
          </div>

          <h2 className="text-2xl font-light text-gray-900 mb-4">Calendrier Non Synchronisé</h2>
          ...
          <button
            onClick={onClose}
            className="w-full px-8 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white rounded-full text-sm font-light hover:from-blue-600 hover:to-blue-700 shadow-md transition-all hover:scale-105"
          >
